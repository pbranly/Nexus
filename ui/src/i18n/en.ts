...
export const EN = {
  ...
  'settings.rigControl.conn.sdrconnect': 'SDRconnect (WebSocket)',
  'settings.rigControl.sdrconnect.address.label': 'SDRconnect WebSocket address',
  'settings.rigControl.sdrconnect.address.hint': 'Direct connection to the SDRconnect WebSocket API. Enter the endpoint exposed by SDRconnect, for example ws://192.168.1.50:PORT.',
  'settings.rigControl.sdrconnect.address.required': 'Enter the SDRconnect WebSocket address first.',
  'settings.rigControl.sdrconnect.test.action': 'Test SDRconnect',
  'settings.rigControl.sdrconnect.test.testing': 'Testing SDRconnect…',
  'settings.rigControl.sdrconnect.test.failed': 'SDRconnect WebSocket test failed.',
  'settings.rigControl.sdrconnect.test.title': 'Connect to SDRconnect and read the current VFO frequency.',
